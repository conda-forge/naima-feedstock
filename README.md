About naima-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/naima-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4046&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/naima-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `naima` can be installed with `conda`:
...
It is possible to list all of the versions of `naima` available on your platform with `conda`:
...
```
mamba search naima --channel conda-forge
```
...
mamba repoquery search naima --channel conda-forge

# List packages depending on `naima`:
mamba repoquery whoneeds naima --channel conda-forge

# List dependencies of `naima`:
mamba repoquery depends naima --channel conda-forge
```
